    ...
    public static class ResponseService
    {
        ...
        private static readonly Dictionary<string, List<ResponseTemplate>> _responses = new(StringComparer.OrdinalIgnoreCase)
        {
            ...
            ["worried"] = new() {
                ...
                new("🛡️ It's completely normal to feel worried about security. Here's how we can protect you...", ConsoleColor.Cyan),
            ...
            ["frustrated"] = new() {
                new("⚠️ I hear your frustration. Let's tackle this problem step by step.", ConsoleColor.Yellow),
                ...
                new("🛠️ Frustration is understandable. Here's how we can fix this...", ConsoleColor.Blue)
            },
        ...
        public static string GetResponse(string input)
        {
            ...
            // Check for sentiment-specific responses first
            if (sentiment != "neutral" && _responses.ContainsKey(sentiment))
            {
                var response = GetUniqueResponse(sentiment);
                return string.IsNullOrEmpty(sentimentAdjustment)
                    ? response
                    : $"{sentimentAdjustment} {response}";
            }

            // Rest of the existing response logic...
            // [Previous category detection logic remains unchanged]
